...
class Need(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, project_id, id, *args, **kwargs):  # noqa: E501
        """Need - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, project_id, id, *args, **kwargs):  # noqa: E501
        """Need - a model defined in OpenAPI

...
class FilterApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.filter_needs_api_filter_needs_post_endpoint = _Endpoint(
            settings={
                'response_type': ([Need],),
                'auth': [],
                'endpoint_path': '/api/filter/needs',
                'operation_id': 'filter_needs_api_filter_needs_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def filter_needs_api_filter_needs_post(
        self,
        filter,
        **kwargs
    ):
        ...
        >>> thread = api.filter_needs_api_filter_needs_post(filter, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['filter'] = \
            filter
        return self.filter_needs_api_filter_needs_post_endpoint.call_with_http_info(**kwargs)
